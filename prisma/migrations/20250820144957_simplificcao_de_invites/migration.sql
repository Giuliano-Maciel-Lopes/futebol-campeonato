/*
  ...
  - The values [REJECTED,CANCELED] on the enum `InviteStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."InviteStatus_new" AS ENUM ('PENDING', 'ACCEPTED');
...
ALTER TABLE "public"."Invite" ALTER COLUMN "status" SET DEFAULT 'PENDING';
COMMIT;
